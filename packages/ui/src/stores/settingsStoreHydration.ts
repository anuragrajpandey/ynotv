...
const BOOLEAN_KEYS = new Set([
  ...
  'vodShowSourceBadge', 'blurUnwatchedEpisodes', 'useScrollwheelSeek', 'useScrollwheelSeekInvert', 'failoverGroupShowSource', 'failoverAlwaysPlayPrimary', 'showFailoverLiveTvWidget', 'showFailoverMediaBarWidget',
