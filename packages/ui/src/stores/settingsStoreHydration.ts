...
const BOOLEAN_KEYS = new Set([
  ...
  'vodShowSourceBadge', 'blurUnwatchedEpisodes', 'useScrollwheelSeek', 'useScrollwheelSeekInvert', 'failoverGroupShowSource', 'showFailoverLiveTvWidget', 'showFailoverMediaBarWidget',
  ...
  'epgMetadataBadgeResolution', 'epgMetadataBadgeFps', 'epgMetadataBadgeFpsSuffix', 'epgMetadataBadgeSound', 'epgMetadataBadgeBitrate', 'epgMetadataBadgeAudioBitrate',
