            ...
            {active && (
                <div className="multiview-cell-controls">
                    ...
                    <div className="multiview-cell-controls-buttons">
                        ...
                        <button className="multiview-cell-controls-btn" onClick={(e) => { e.stopPropagation(); onSetProperty('pause', false); }} title={t('play')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z" /></svg>
                        </button>
                        <button className="multiview-cell-controls-btn" onClick={(e) => { e.stopPropagation(); onSetProperty('pause', true); }} title={t('pause')}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" /></svg>
                        </button>
                        <button className="multiview-cell-controls-btn" onClick={handleReload} title={t('reloadStream')}>
