...
const SETTINGS_SEARCH_INDEX: SettingsSearchResult[] = [
  ...
  { id: 'epg-metadata-badges', label: 'Metadata Badges (Resolution, FPS, Sound, Video Bitrate, Audio Bitrate)', description: 'Enable or disable resolution, FPS, sound, and average video/audio bitrate metadata badges on channel rows in the EPG grid.', tabId: 'livetv', tabLabel: 'LiveTV', subTabId: 'epg', section: 'EPG' },
  // LiveTV > Logos
