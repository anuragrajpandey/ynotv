...
const KEYS = [
  ...
  'settings.controllers.keyboard.title',
  'settings.controllers.keyboard.description',
  'settings.controllers.keyboard.enableLabel',
  'settings.controllers.keyboard.enableHint',
  'settings.controllers.keyboard.reset',
  'settings.controllers.keyboard.pressKey',
  'settings.controllers.keyboard.unmapped',
  'settings.controllers.keyboard.unmap',
  'probe.failoverScopeFilter',
  'probe.failoverAll',
  'probe.failoverMissingBadges',
